...
# Auto-detect and set CUDA_HOME before importing torch
if 'CUDA_HOME' not in os.environ and 'CUDA_PATH' not in os.environ:
    ...
    # If not found, try conda's cudatoolkit
    if not cuda_home:
...
def init_images(global_state):
    ...
    state['renderer'].init_network(
        ...
        state['params']['lr'],  # lr,
        #
        state['params'].get('is_raft', False)  # is_raft
        #
    )
